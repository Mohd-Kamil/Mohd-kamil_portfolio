          ...
          <div className="flex-1 flex flex-col items-start justify-start max-w-xl w-full mb-12 lg:mb-0">
            ...
            <div className="w-full flex flex-col items-center mb-6">
              <div className="w-full max-w-3xl flex flex-col items-center">
                <svg viewBox="0 0 800 160" width="100%" height="160" className="mb-2">
                  {/* Timeline line */}
                  <line x1="60" y1="60" x2="740" y2="60" stroke="#bbb" strokeWidth="4" />
                  {/* Steps */}
                  {/* Morning */}
                  <circle cx="60" cy="60" r="28" fill="#23272f" stroke="#fff" strokeWidth="2.5" />
                  <g><foreignObject x="46" y="46" width="28" height="28"><Sun color="#fff" size={28} /></foreignObject></g>
                  <text x="60" y="115" fill="#fff" fontSize="22" fontWeight="bold" textAnchor="middle" style={{textShadow:'0 2px 8px #000, 0 0 2px #fff', fontFamily:'Inter,sans-serif'}}>Morning</text>
                  <text x="60" y="140" fill="#e0e0e0" fontSize="18" fontWeight="500" textAnchor="middle" style={{textShadow:'0 2px 8px #000', fontFamily:'Inter,sans-serif'}}>Code Review</text>
                  {/* Midday */}
                  <circle cx="260" cy="60" r="28" fill="#23272f" stroke="#fff" strokeWidth="2.5" />
                  <g><foreignObject x="246" y="46" width="28" height="28"><Lightbulb color="#fff" size={28} /></foreignObject></g>
                  <text x="260" y="115" fill="#fff" fontSize="22" fontWeight="bold" textAnchor="middle" style={{textShadow:'0 2px 8px #000, 0 0 2px #fff', fontFamily:'Inter,sans-serif'}}>Midday</text>
                  <text x="260" y="140" fill="#e0e0e0" fontSize="18" fontWeight="500" textAnchor="middle" style={{textShadow:'0 2px 8px #000', fontFamily:'Inter,sans-serif'}}>Brainstorming</text>
                  {/* Evening */}
                  <circle cx="500" cy="60" r="28" fill="#23272f" stroke="#fff" strokeWidth="2.5" />
                  <g><foreignObject x="486" y="46" width="28" height="28"><Palette color="#fff" size={28} /></foreignObject></g>
                  <text x="500" y="115" fill="#fff" fontSize="22" fontWeight="bold" textAnchor="middle" style={{textShadow:'0 2px 8px #000, 0 0 2px #fff', fontFamily:'Inter,sans-serif'}}>Evening</text>
                  <text x="500" y="140" fill="#e0e0e0" fontSize="18" fontWeight="500" textAnchor="middle" style={{textShadow:'0 2px 8px #000', fontFamily:'Inter,sans-serif'}}>UI Design</text>
                  {/* Night */}
                  <circle cx="740" cy="60" r="28" fill="#23272f" stroke="#fff" strokeWidth="2.5" />
                  <g><foreignObject x="726" y="46" width="28" height="28"><Moon color="#fff" size={28} /></foreignObject></g>
                  <text x="740" y="115" fill="#fff" fontSize="22" fontWeight="bold" textAnchor="middle" style={{textShadow:'0 2px 8px #000, 0 0 2px #fff', fontFamily:'Inter,sans-serif'}}>Night</text>
                  <text x="740" y="140" fill="#e0e0e0" fontSize="18" fontWeight="500" textAnchor="middle" style={{textShadow:'0 2px 8px #000', fontFamily:'Inter,sans-serif'}}>Vibe Coding</text>
                </svg>
              </div>
                ...
                <CardContent className="pt-0">
                  ...
                  <div className="flex gap-2 sm:gap-3 mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <a
                      ...
                      className="flex-1 btn-primary text-xs sm:text-sm flex items-center justify-center rounded-xl px-2 py-1"
                    >
